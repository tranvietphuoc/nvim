    ...
    setup = function()
        ...
        require("lazy").setup({
            ...
            },
            {
                ...
                keys = {
                    { "<leader>a", nil, desc = "AI assistants" },
            ...
            },
            {
                ...
                keys = {
                    ...
                    { "<leader>aR", "<cmd>CodexResume<cr>", desc = "Resume Codex session" },
                    { "<leader>aN", "<cmd>CodexContinue<cr>", desc = "Continue latest Codex session" },
                    { "<leader>aF", "<cmd>CodexFork<cr>", desc = "Fork Codex session" },
                    { "<leader>aV", "<cmd>CodexReview<cr>", desc = "Review changes with Codex" },
                    { "<leader>ap", "<cmd>CodexPrompt<cr>", desc = "Prompt Codex" },
                    { "<leader>aq", "<cmd>CodexAsk<cr>", desc = "Ask Codex about buffer" },
                    { "<leader>al", "<cmd>CodexFollowUp<cr>", desc = "Follow up with Codex" },
                    { "<leader>aD", "<cmd>CodexDiff<cr>", desc = "Show Codex diff" },
                    { "<leader>ai", "<cmd>CodexInterrupt<cr>", desc = "Interrupt Codex" },
                    { "<leader>az", "<cmd>CodexStatus<cr>", desc = "Show Codex status" },
                    { "<leader>ah", "<cmd>CodexHealth<cr>", desc = "Check Codex health" },
                    { "<leader>aB", "<cmd>CodexAdd<cr>", desc = "Add current buffer to Codex" },
                    { "<leader>aa", ":<C-U>CodexAskVisual<CR>", mode = "v", desc = "Ask Codex about selection" },
                    { "<leader>aE", ":<C-U>CodexEdit<CR>", mode = "v", desc = "Edit selection with Codex" },
                    {
                        "<leader>aS",
                    ...
                    },
                    {
                        ...
                        mode = "v",
                        desc = "Add selection to Codex",
                    },
                    {
                        "<leader>aT",
                        "<cmd>CodexTreeAdd<cr>",
                        desc = "Add explorer paths to Codex",
                        ft = { "NvimTree", "neo-tree", "oil", "minifiles", "netrw" },
                    },
                },
            },
